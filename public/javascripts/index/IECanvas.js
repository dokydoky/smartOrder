...
(function () {
  ...
  2007.3.19		원래 스펙에선 제공하지 않는 text 태그를 처리하기 위하여 추가하였다

  ********************************************************************************************************************************/

  contextPrototype.text = function(aX, aY, font_family,font_size,fill,text_anchor,width,height,text) {	  
	var vmlTextString = "";
    ...
    vmlText.push(' <g_vml_:shape style="position: absolute;left: ', this.getTextLeftValue(Math.round(aX), font_size, text, text_anchor),
                ' ; top: ',  Math.round(aY - 5),
                ' ; width: ' ,  Math.round(width),
                ' ; height: ',  Math.round(height),
				' ;" coordorigin="0 0" coordsize=" ',  Math.round(width), ' ',  Math.round(height),
				' " opacity="1"><g_vml_:stroke on="false" endcap="flat" joinstyle="miter" miterlimit="4" dashstyle="solid" opacity="1"/><g_vml_:fill on="true" color=" ', fill,
				' " opacity="1"/><g_vml_:path textpathok="true" v="m 0,0 l ', this.getTextValue(font_size, text, text_anchor),
				' ,0 e"/><g_vml_:textpath on="true" style="font-family:  ', font_family,
				' ; font-size: ', font_size,
				' ; " fitpath="f" string="', vmlTextString,	
				' "/></g_vml_:shape> ');
  };

  contextPrototype.getTextLeftValue = function(aX, font_size, text, text_anchor) {
	  ...
	  if(text_anchor == "start") {
		  ...
		  if(font_size > 0 || len > 0)  {
			  var a = Math.floor((font_size + 1) / 7);	  //1
			  var b = (font_size + 1) % 7;	  //4
			  if(text_anchor == "middle") {
				e = 2.5;
				f = 0.5;
			  } else {
  ...
  contextPrototype.getTextValue = function(font_size, text, text_anchor) {	 
	  if(font_size > 0) {
		  var e;
		  var len = text.length;
		  var a = Math.floor((font_size + 1) / 7);	  
		  var b = (font_size + 1) % 7;
		  if(text_anchor == "middle") {
			  e = 4;
		  } else {
  ...
  *******************************************************************************************************************/
  ...
  contextPrototype.stroke = function(aFill) {
	...
	if(vmlText.join("") != "") {
		//alert(vmlText.join(""));
		this.element_.insertAdjacentHTML("beforeEnd", vmlText.join(""));	
		vmlText = [];
	}
	//parent.rj.innerText = this.element_.innerHTML
    this.currentPath_ = [];
  };
